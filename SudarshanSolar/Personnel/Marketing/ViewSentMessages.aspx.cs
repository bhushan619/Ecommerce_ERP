    ...
    public partial class ViewSentMessages : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if (!IsPostBack)
            {
                ...
                notifications();
                SqlDataSourceMessages.SelectCommand = "SELECT varMessageByName, varMessageToName, varEnquirySubject, dtDate, tmTime, intId FROM tblsuenquiry WHERE intMessageById= " + rex.DecryptString(Request.Cookies["LoginId"].Value.ToString()) + " order by CAST( STR_TO_DATE( dtDate,  '%d-%m-%Y' ) AS DATE  )";
            }
        }
