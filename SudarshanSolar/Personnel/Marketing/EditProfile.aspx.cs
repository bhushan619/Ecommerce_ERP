    ...
    public partial class EditProfile : System.Web.UI.Page
    {
        ...
        public void getEmpdata()
        {
            try
            {
                ...
                dbc.con.Open();
                MySql.Data.MySqlClient.MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand("SELECT varName, varMobile,varAddress, varCity, varState, varIDProof, varIDProofNo, varPanCardNo FROM anuvaa_solar.tblsupersonnel where intId=" + rex.DecryptString(Request.Cookies["LoginId"].Value) + "", dbc.con);
