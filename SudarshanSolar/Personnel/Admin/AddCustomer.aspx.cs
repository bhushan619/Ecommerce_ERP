        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //{
                    if (txtCmpName.Text == "")
                    {
                    MessageDisplay(Resources.Common.companyname, "alert dark  alert-dismissible  alert-danger");

                }
                else if (txtMobile.Text == "")
                    {
                    MessageDisplay(Resources.Common.mbno, "alert dark  alert-dismissible  alert-danger");

                }
                else if (cmbcity.Text == "--Select City--")
                    {
                    MessageDisplay(Resources.Common.city, "alert dark  alert-dismissible  alert-danger");
