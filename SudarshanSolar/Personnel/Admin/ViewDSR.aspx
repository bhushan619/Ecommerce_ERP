<%@ Page Title="" Language="C#" MasterPageFile="~/Personnel/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="ViewDSR.aspx.cs" Inherits="SudarshanSolar.Personnel.Admin.ViewDSR" %>
                             ...
                             <Columns>
                                <asp:BoundField DataField="varDate" HeaderText="Date" 
                                 ...
                                 <asp:BoundField DataField="varLocation" HeaderText="Location" 
                                  ...
                                  <asp:BoundField DataField="varEmpName" HeaderText="EmployeeName" 
