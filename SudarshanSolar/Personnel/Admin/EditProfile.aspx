<%@ Page Title="" Language="C#" MasterPageFile="~/Personnel/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="SudarshanSolar.Personnel.Admin.EditProfile" %>
...
<div class="row">
      ...
      <div class="panel">
                     <div class="panel-heading">
                      <h3 class="panel-title"><i class="icon md-edit" aria-hidden="true"></i>Edit Profile</h3>
                     </div>
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload"> 
                                ...
                                <input ID="fupProPic" type="file" name="file" onchange="previewFile()"  runat="server" accept='image/*' /></span>
                                   <br />  <br />
                                        <asp:Image ID="imgProPic" CssClass="fileupload-preview thumbnail" style="width: 200px; height: 150px;float:none"  runat="server" ImageUrl="~/media/Employee/NoProfile.png" />
