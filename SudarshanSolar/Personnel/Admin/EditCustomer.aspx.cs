            ...
            try
            {
                ...
                //{
                    ...
                    if (contentLength == 0)
                    {
                        ...
                        int insert_ok = dbc.update_tblsucustomeradmin( Cache["custbyadmin"].ToString(), txtCmpName.Text, txtRepName.Text, txtMobile.Text, txtLandline.Text, txtADD.Text, cmbcity.Text, cmbstate.Text, "true", txtPAN.Text, txtVat.Text, txtTincard.Text, "NoProfile.png", txtDOET.Text);
                        if (insert_ok == 1)
                        {
                    ...
                    {
                        int insert_ok = dbc.update_tblsucustomeradmin( Cache["custbyadmin"].ToString(), txtCmpName.Text, txtRepName.Text, txtMobile.Text, txtLandline.Text, txtADD.Text, cmbcity.Text, cmbstate.Text, "true", txtPAN.Text, txtVat.Text, txtTincard.Text, fileName, txtDOET.Text);
                        if (insert_ok == 1)
                        {
