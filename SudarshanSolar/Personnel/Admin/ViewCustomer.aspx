<%@ Page Title="" Language="C#" MasterPageFile="~/Personnel/MasterPages/Admin.Master" AutoEventWireup="true" CodeBehind="ViewCustomer.aspx.cs" Inherits="SudarshanSolar.Personnel.Admin.ViewCustomer" %>
           ...
           <div clientidmode="static" role="alert" id="divMessage" runat="server" visible="false">
                            ...
                            <asp:ListView ID="listcust" runat="server" DataSourceID="SqlDataSource2" OnItemCommand="listproduct_ItemCommand"
                                ...
                                <ItemTemplate>
                                  ...
                                  <td>
                                            <%-- <asp:LinkButton ID="DeleteButton" runat="server" CommandName="Deletes" CommandArgument='<%#Eval("intId")+","+ Eval("varStatus")%>'
                                            CssClass="btn btn-xs btn-danger"    Text="Delete" />--%>
                                            <asp:LinkButton ID="EditButton" runat="server" CommandName="Edits" ToolTip="Edit"  CommandArgument='<%#Eval("intId")+","+ Eval("varStatus")%>' CssClass="icon md-edit btn-xs  btn btn-warning"/>
                                               <asp:LinkButton ID="DetailsUpdate" CssClass="icon md-swap btn-xs  btn btn-primary" runat="server" CommandName="Updates" ToolTip="Change List" CommandArgument='<%#Eval("intId")+","+ Eval("varStatus")%>' />
                                        </td>
                                    </tr>
                                </ItemTemplate> 
                                  <EmptyDataTemplate>
