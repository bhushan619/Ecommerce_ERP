<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="SudarshanSolar.Register" %>
  ...
  <div class="page animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content">
      ...
      <div class="page-login-main">
        ...
        <h3 class="font-size-24">New User Signup!</h3>
  ...
  <form id="g" runat="server">
					<div class="signup-form"><!--sign up form-->
                         ...
                         <table >
                             <tr>
                                 <td>
                               <label class="jbold"> Sign up as</label> &nbsp; &nbsp; </td>
                                 <td>  <input type="radio"  ID="rdbEmployee" runat="server"  name="desig" value="employee"    required/>&nbsp;<label> Employee</label>
                                      </td>
                                 <td ><input type="radio" name="desig" value="customer" ID="rdbCustomer" runat="server"   required/>&nbsp;<label >Customer</label>
                                   
                                  </td>
                             </tr>
                         </table> 
                           <div class="form-group form-material floating">
                            <input type="text" id="txtName" runat="server"    required="required"  class="form-control empty"/>
                                <label class="floating-label" for="inputName">Name</label>

                           </div>
                           <div class="form-group form-material floating">
                            <input type="text" id="txtMail"    runat="server"  Required="required"  class="form-control empty" />
                                <label class="floating-label" for="inputEmail">Email</label>

                           </div>
                           <div class="form-group form-material floating">
                             <input type="password" id="txtPasswd" runat="server"    onkeyup="checkPassCol(); return false;"     TextMode="Password"  required="required" class="form-control empty"   />
                                 <label class="floating-label" for="inputPassword">Password</label>
                           </div>
                           <div class="form-group form-material floating">
                               <input type="password" id="txtConfirmPass" runat="server"      onkeyup="checkPassCol(); return false;" TextMode="Password"      required="required" class="form-control empty"/>
                                    <label class="floating-label" for="inputPasswordCheck">Confirm Password</label>
                               </div>
                           <div class="form-group form-material floating">
                         <input type="text" id="txtMobile" runat="server"      pattern="[7-9]{1}[0-9]{9}"  required="required"      class="form-control empty"  />
                                    <label class="floating-label" for="inputPasswordCheck">Mobile No</label>
                               </div>
				            	<button  runat="server"   onserverclick="btnSubmit_Click" class="btn btn-primary btn-block"  >Sign up</button>
     ...
     <div class="form-group form-material floating">
       ...
       <p>Have account already? Please go to <a href="Login.aspx">Sign In</a></p>
