<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/OutsideMaster.Master" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="SudarshanSolar.Customer.Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<h1 class="highlight bold">Invoice</h1>
							<ol class="breadcrumb">
								<li>
									<a href="Default.aspx">
										HomePage
      ...
      <section class="ls ms  section_padding_top_25 ">
				<div class="container">
					<div class="row">
...
<div class="">
							...
							<div class="text-right mr-lg">
								<asp:LinkButton ID="btnprint" runat="server"  OnClientClick="javascript:printDiv('printablediv');" CssClass="theme_button wide_button color1" ><i class="fa fa-print"></i> Print</asp:LinkButton>
								<a href="Dashboard.aspx" class="theme_button wide_button">Cancel</a>
							</div>
